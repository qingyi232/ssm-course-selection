...
<body>
    ...
    <div class="container">
        ...
        <c:if test="${param.msg == 'success'}"><div class="alert">信息修改成功</div></c:if>
        <c:if test="${param.msg == 'pwd_success'}"><div class="alert">密码修改成功</div></c:if>
        <form action="profile" method="post">
            <input type="hidden" name="action" value="update">
            <div class="form-group"><label>工号</label><input type="text" class="form-control" value="${teacher.teacherNo}" disabled></div>
            <div class="form-group"><label>姓名</label><input type="text" class="form-control" value="${teacher.name}" disabled></div>
            <div class="form-group"><label>性别</label><input type="text" class="form-control" value="${teacher.gender}" disabled></div>
            <div class="form-group"><label>职称</label><input type="text" class="form-control" value="${teacher.title}" disabled></div>
            <div class="form-group"><label>学院</label><input type="text" class="form-control" value="${teacher.collegeName}" disabled></div>
            <div class="form-group"><label>联系电话</label><input type="text" name="phone" class="form-control" value="${teacher.phone}" placeholder="请输入联系电话"></div>
